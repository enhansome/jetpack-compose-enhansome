# Awesome jetpack compose awesome with stars

![Jetpack Compose](./images/logo.png)

📝 A curated list of awesome JetpackCompose libraries, projects, articles and resources.

**See also:** [Android Developer Reference](https://github.com/ImangazalievM/android-developer-reference) ⭐ 344 | 🐛 0 | 🌐 Kotlin | 📅 2022-06-19
...
* 15 January 2022 - [ConstraintLayout for Compose 1.0.0 Released](https://github.com/androidx/constraintlayout/wiki/What's-New-in-1.0-\(Compose\)) ⚠️ Archived
...
* [ComposeCookBook](https://github.com/Gurupreet/ComposeCookBook) ⭐ 6,863 | 🐛 43 | 🌐 Kotlin | 📅 2026-06-28
* [API Guidelines for Jetpack Compose](https://github.com/androidx/androidx/blob/androidx-main/compose/docs/compose-api-guidelines.md) ⭐ 6,054 | 🐛 58 | 🌐 Kotlin | 📅 2026-08-13
...
* [Showkase](https://github.com/airbnb/Showkase) ⭐ 2,315 | 🐛 68 | 🌐 Kotlin | 📅 2026-03-27 - Helps you organize, discover, search and visualize Jetpack Compose UI elements
* [Shot](https://github.com/Karumi/Shot) ⭐ 1,206 | 🐛 63 | 🌐 Kotlin | 📅 2026-01-16 - Jetpack Compose screenshot testing tool
...
* [Appyx](https://github.com/bumble-tech/appyx) ⭐ 1,257 | 🐛 76 | 🌐 Kotlin | 📅 2026-08-05 - Model-driven navigation for Jetpack Compose
* [compose-navigation-reimagined](https://github.com/olshevski/compose-navigation-reimagined) ⭐ 570 | 🐛 7 | 🌐 Kotlin | 📅 2024-01-27 - A small and simple, yet fully fledged and customizable navigation library for Jetpack Compose
...
* [KakaoCup/Compose](https://github.com/KakaoCup/Compose) ⭐ 186 | 🐛 15 | 🌐 Kotlin | 📅 2026-01-09
...
* [accompanist](https://github.com/chrisbanes/accompanist) ⭐ 7,830 | 🐛 11 | 🌐 Kotlin | 📅 2025-08-18 -  A collection of extension libraries for Jetpack Compose
* [Landscapist](https://github.com/skydoves/Landscapist) ⭐ 2,572 | 🐛 7 | 🌐 Kotlin | 📅 2026-08-12 - image loading using Glide, Coil, Fresco
* [Reorderable](https://github.com/Calvin-LL/Reorderable) ⭐ 1,319 | 🐛 29 | 🌐 Kotlin | 📅 2026-04-20 - Reorder items in Lists and Grids with drag and drop
* [compose-markdown](https://github.com/jeziellago/compose-markdown) ⭐ 860 | 🐛 53 | 🌐 Kotlin | 📅 2026-04-27 - Markdown Text for Android Jetpack Compose
...
* [compose-backstack](https://github.com/zach-klippenstein/compose-backstack) ⚠️ Archived - Simple composable for rendering transitions between backstacks.
* [snapper](https://github.com/chrisbanes/snapper) ⚠️ Archived - A snapping fling behavior for Jetpack Compose
* 🆕[](#02-01-24) [compose-recyclerview](https://github.com/canopas/compose-recyclerview/tree/master) ⭐ 206 | 🐛 0 | 🌐 Kotlin | 📅 2024-12-26 - A library that allows seamless integration of composables in RecyclerView, addressing performance concerns and LazyList issues. Enjoy improved rendering performance, built-in drag-and-drop support, flexible configuration, and easy handling of multiple item types for dynamic UIs.
* [AutoLinkText](https://github.com/Calvin-LL/AutoLinkText) ⭐ 89 | 🐛 0 | 🌐 Kotlin | 📅 2025-06-12 - Make links, emails, and phone numbers clickable in text

### UI

* [Konfetti](https://github.com/DanielMartinus/Konfetti) ⭐ 3,384 | 🐛 27 | 🌐 Kotlin | 📅 2025-08-21 - Easily celebrate little and big moments in your app with this lightweight confetti particle system 🎊
* 🆕[](#28-05-23)[Compose-Rich-Editor](https://github.com/MohamedRejeb/Compose-Rich-Editor) ⭐ 1,827 | 🐛 82 | 🌐 Kotlin | 📅 2026-08-11 - A Rich text editor library for both Jetpack Compose and Compose Multiplatform,
* 🆕[](#28-05-23)[telephoto](https://github.com/saket/telephoto) ⭐ 1,541 | 🐛 22 | 🌐 Kotlin | 📅 2026-07-22 - Building blocks for designing media experiences in Compose UI
* [FloatingActionButton SpeedDial](https://github.com/leinardi/FloatingActionButtonSpeedDial) ⭐ 1,473 | 🐛 44 | 🌐 Java | 📅 2024-04-04
* [compose-richtext](https://github.com/zach-klippenstein/compose-richtext) ⭐ 985 | 🐛 44 | 🌐 Kotlin | 📅 2026-06-08 - A collection of Compose libraries for advanced text formatting.
...
* [neumorphic-compose](https://github.com/CuriousNikhil/neumorphic-compose) ⭐ 464 | 🐛 3 | 🌐 Kotlin | 📅 2021-10-02 - Neumorphism UI with Jetpack Compose. Just add simple `neumorphic()` modifier.
...
* [SwipeAbleViews](https://github.com/SimformSolutionsPvtLtd/SSJetpackComposeSwipeableView) ⭐ 113 | 🐛 0 | 🌐 Kotlin | 📅 2022-07-27 - SSJetpackComposeSwipeableView is a small library which provides support for the swipeable views. You can use this in your lazyColumns or can add a simple view which contains swipe to edit/delete functionality.
* [Dark-Toggle-Button-Sample-Jetpack-Compose](https://github.com/lcdsmao/Dark-Toggle-Button-Sample-Jetpack-Compose) ⭐ 111 | 🐛 0 | 🌐 Kotlin | 📅 2021-09-12  (**+50** ⭐) -  Animated dark mode toggle button with Jetpack Compose.
* [ComposeDynamicTheme](https://github.com/seyoungcho2/ComposeDynamicTheme) ⭐ 109 | 🐛 0 | 🌐 Kotlin | 📅 2023-07-23 - Material design based Theme Management System for Jetpack Compose
* [shimmer](https://github.com/ValeryPonomarenko/compose-shimmer) ⭐ 99 | 🐛 0 | 🌐 Kotlin | 📅 2023-07-31 - Shimmer effect
* [WYSIWYG Rich Editor Compose](https://github.com/canopas/rich-editor-compose) ⭐ 97 | 🐛 1 | 🌐 Kotlin | 📅 2024-12-26 - Android WYSIWYG Rich editor for Jetpack compose.
* [YouTubePlayer](https://github.com/IlyaPavlovskii/YouTubePlayer) ⭐ 92 | 🐛 4 | 🌐 Kotlin | 📅 2026-06-11 - YouTube kotlin multiplatform player. The YouTubePlayer composable allows you to embed a YouTube video player in your Jetpack Compose app.
* [heart-switch](https://github.com/popovanton0/heart-switch) ⭐ 77 | 🐛 0 | 🌐 Kotlin | 📅 2024-10-11 - ❤️ A heart-shaped toggle switch component for Jetpack Compose
* [compose-sliders](https://github.com/krottv/compose-sliders) ⭐ 66 | 🐛 2 | 🌐 Kotlin | 📅 2022-10-02 - Custom Sliders (previously known as SeekBar) for jetpack compose

## <a name="app-projects"></a> App Projects

* [Jetpack Compose Samples](https://github.com/android/compose-samples) ⭐ 23,371 | 🐛 5 | 🌐 Kotlin | 📅 2026-08-03 (**+15.9K** ⭐) - Official repository with samples by Google
...
* [ComposeAcademy-Playground](https://github.com/hitherejoe/ComposeAcademy-Playground) ⭐ 968 | 🐛 2 | 🌐 Kotlin | 📅 2021-04-08 (**+870** ⭐)
* [JetInstagram](https://github.com/vipulasri/JetInstagram) ⭐ 841 | 🐛 2 | 🌐 Kotlin | 📅 2022-07-09 (**+689** ⭐) - Instagram clone app built with Jetpack Compose
...
* [Intro Showcase View](https://github.com/canopas/Intro-showcase-view) ⭐ 612 | 🐛 7 | 🌐 Kotlin | 📅 2024-12-26 (**+15** ⭐) - An android library to highlight different features of the app built using Jetpack Compose.
* [JetQuotes](https://github.com/Spikeysanju/JetQuotes) ⭐ 550 | 🐛 9 | 🌐 Kotlin | 📅 2024-04-16 (**+363** ⭐) -  A Quotes Application
* [flux](https://github.com/fidloo/flux) ⭐ 511 | 🐛 2 | 🌐 Kotlin | 📅 2023-05-11 (**+335** ⭐) - A fake weather app
* [Wiggles](https://github.com/Spikeysanju/Wiggles) ⭐ 503 | 🐛 3 | 🌐 Kotlin | 📅 2021-09-07 (**+256** ⭐) - Beautiful Puppy adoption app with Jetpack Compose
* [Jetpack-compose-animations-examples](https://github.com/canopas/Jetpack-compose-animations-examples) ⭐ 489 | 🐛 1 | 🌐 Kotlin | 📅 2024-12-26 (**+4** ⭐) - Cool animations implemented with Jetpack Compose.
* [android-2048-compose](https://github.com/alexjlockwood/android-2048-compose) ⭐ 472 | 🐛 0 | 🌐 Kotlin | 📅 2024-10-21 (**+255** ⭐) - 2048 implemented using Jetpack Compose
* [JetpackComposeCalculator](https://github.com/ahmedrizwan/JetpackComposeCalculator) ⭐ 314 | 🐛 2 | 🌐 Kotlin | 📅 2020-08-11 (**+272** ⭐)
* [DinoCompose](https://github.com/wajahatkarim3/DinoCompose) ⭐ 285 | 🐛 4 | 🌐 Kotlin | 📅 2022-01-09 (**+198** ⭐) -  Chrome's Dino T-Rex game developed in Jetpack Compose
* [compose-schedule-calendar](https://github.com/halilozercan/compose-schedule-calendar) ⭐ 242 | 🐛 1 | 🌐 Kotlin | 📅 2021-05-24 (**+142** ⭐) - Demo app for a horizontal schedule(event) calendar
* [JetExample](https://github.com/gastsail/JetExample) ⭐ 224 | 🐛 0 | 🌐 Kotlin | 📅 2022-01-31 (**+192** ⭐) - Jetpack Compose UI components examples
* [Rebound](https://github.com/AnkitSuda/Rebound) ⚠️ Archived (**+7** ⭐) - Highly customizable and feature rich workout log app.
* [CoinWatch](https://github.com/shorthouse/CoinWatch) ⭐ 147 | 🐛 4 | 🌐 Kotlin | 📅 2026-06-23 (**29** ⭐) - Delightful cryptocurrency app providing real-time coin prices, price histories, and market data
* [Facebook-Timeline-Compose-Android](https://github.com/ahmed7official/Facebook-Timeline-Compose-Android) ⭐ 146 | 🐛 0 | 🌐 Kotlin | 📅 2021-03-13 (**+119** ⭐)
* [jettimer](https://github.com/ericktijerou/jettimer) ⭐ 134 | 🐛 0 | 🌐 Kotlin | 📅 2021-03-08 (**+26** ⭐) - Timer app clone built with Jetpack Compose and Hilt
...
* [jetpack-compose-samples](https://github.com/RajashekarRaju/jetpack-compose-samples) ⭐ 87 | 🐛 0 | 🌐 Kotlin | 📅 2022-07-30 (**+18** ⭐) - Repository with collection of many compose samples.

## Android TV

* 🆕[](#28-05-23) [ComposeTv](https://github.com/UmairKhalid786/ComposeTv) ⭐ 281 | 🐛 5 | 🌐 Kotlin | 📅 2026-04-06 - Android TV built using Jetpack Compose TV APIs
...
* [Compose JB](https://github.com/JetBrains/compose-jb) ⭐ 19,291 | 🐛 31 | 🌐 Kotlin | 📅 2026-08-13 - Jetpack Compose for Desktop and Web
...
* [ComposeClock](https://github.com/adibfara/ComposeClock) ⭐ 433 | 🐛 1 | 🌐 Kotlin | 📅 2021-11-04
...
* [Jetpack-Compose-Playground](https://github.com/Foso/Jetpack-Compose-Playground) ⭐ 3,654 | 🐛 16 | 🌐 Kotlin | 📅 2026-03-31 - Community-driven collection of Jetpack Compose example code and tutorials 🚀
